...
def process_canvas_sync_webhook(event_data):
    ...
    # --- Getting student details... (This part is unchanged) ---
    ...
    # --- Determining classes to enroll/unenroll... (This part is unchanged) ---
    ...
    # --- MODIFIED: Enrollment loop with subitem logging ---
